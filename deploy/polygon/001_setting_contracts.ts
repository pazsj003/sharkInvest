...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  async function setD3Vault(shouldSet: boolean) {
    ...
    if (shouldSet) {
      ...
      console.log("add liquidator1...");
      await D3Vault.addLiquidator(process.env.LIQUIDATOR1);
      console.log("add liquidator2...");
      await D3Vault.addLiquidator(process.env.LIQUIDATOR2);
      ...
      await D3Vault.addNewToken(
        ...
        bignumberFromE(10000e8),
        bignumberFromE(5000e8),
        bignumberFromE(90e16),
        bignumberFromE(110e16),
        bignumberFromE(10e16),
      );

      console.log("addNewToken WMATIC...");
      await D3Vault.addNewToken(
        config.defaultAddress.WMATIC,
        bignumberFromE(1000000e18),
        bignumberFromE(500000e18),
        bignumberFromE(90e16),
        bignumberFromE(110e16),
